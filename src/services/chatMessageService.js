...
const ChatMessageService = {
  async createMessage({
    ...
    /*
     * Push notifications — sent to other room members after the
     * message is durably created. `otherMembers` only carries
     * ChatRoomMember.role (room-level ADMIN/MEMBER), not the
     * account-level PLAYER/SCOUT/ADMIN role the push spec needs,
