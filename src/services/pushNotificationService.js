...
export const PushNotificationType = {
  ...
  // "Someone you follow just came online" — routes to their profile,
...
function buildNotificationData({
  ...
  switch (type) {
    ...
    case PushNotificationType.ONLINE:
      // Opens the followed user's profile, same routing shape as FOLLOW.
      if (!actorUserId) {
        const error = new Error('ONLINE notifications require actorUserId');
        error.statusCode = 400;
        throw error;
      }
      return {
