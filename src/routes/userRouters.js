 ...
 * /users/{id}/presence:
 *   get:
 *     summary: Online status of a user (followers, following, chat contacts only)
 *     tags: [Users]
 *     security: [{ bearerAuth: [] }]
 *     parameters:
 *       - in: path
 ...
 *     responses:
 *       200:
 *         description: "{ userId, status: 'online'|'offline', lastSeenAt }"
 *       403:
 *         description: Not allowed to see this user's presence
 */
router.get('/:id/presence', authenticate, userController.getPresence);
