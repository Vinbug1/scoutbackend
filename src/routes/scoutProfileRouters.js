...
// import express from 'express';
// import { upload } from '../config/multer.js'; // ✅ import shared multer (diskStorage)
// import scoutProfileController from '../controllers/scoutProfileController.js';
// import { verifyToken as authenticate, authorizeRoles } from '../middleware/auth.js';
...
//  */
// // ⚠️ Must be declared BEFORE /:id
// router.post('/avatar', authenticate, authorizeRoles('SCOUT'), upload.single('avatar'), scoutProfileController.uploadAvatar);
