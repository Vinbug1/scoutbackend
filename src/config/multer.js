...
//     // ── Step 1: Encode every rendition to its own sub-folder ─────────────
//     await Promise.all(
//       renditions.map(({ label, height, videoBitrate, audioBitrate }) => {
//         const rendDir = path.join(tmpDir, label);
//         fs.mkdirSync(rendDir, { recursive: true });
...
//     // ── Step 2: Build the master playlist ────────────────────────────────
//     const bandwidthMap = {
//       '1080p': 4500000,
//       '720p':  2800000,
//       '480p':  1400000,
...
//     // ── Step 3: Extract + compress thumbnail ─────────────────────────────
//     await new Promise((resolve, reject) => {
//       ffmpeg(inputPath)
//         .screenshots({ timestamps: ['00:00:01'], filename: 'thumbnail.jpg', folder: tmpDir, size: '1024x?' })
//         .on('end', resolve)
...
//     return {
//       url:          masterUrl,   // master.m3u8 — feed directly into your player
//       thumbnailUrl,
//       fileName,
//       mediaType:    'video',
